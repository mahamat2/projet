...
class Salaires {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Vendeur("18B001","abakar", "moussa", 55, "1995", 10000));
        p.ajouterEmploye(new Representant("11D002","mahamat", "ahmat", 28, "2001", 20000));
        p.ajouterEmploye(new Technicien("18C003","fadul", "abdel", 28, "1998", 1000));
        p.ajouterEmploye(new Manutentionnaire("22A003","brahim", "haroun", 33, "1998", 45));
        p.ajouterEmploye(new TechnARisque("17B025","mahamout", "bichara", 48, "2010", 1000));
        p.ajouterEmploye(new ManutARisque("22A124","paul", "pirre", 31, "2001", 45));
